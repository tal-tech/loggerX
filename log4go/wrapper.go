...
// Wrapper for (*Logger).LoadLogConfig
func LoadLogConfig(config *LogConfig) {
	Global.LoadLogConfig(config)
}
...
//	Added by xueersi
///////////////////////////////////
func LogTrace(lvl Level, source, message string, traceMeta *map[string]string) {
	Global.LogTrace(lvl, source, message, traceMeta)
}

func LogTraceMap(lvl Level, source, message string, traceFields map[string]string) {
	Global.LogTraceMap(lvl, source, message, traceFields)
}
